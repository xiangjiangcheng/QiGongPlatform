...
<div class="pet_mian" >
    <div class="pet_head">
        ...
        <div class="am-header-left am-header-nav ">
          <a href="/index.php/Admin/Attention/showListPage" class="iconfont pet_head_jt_ico">&#xe601;</a>参赛须知详情
        </div>
        </header>
    </div>
    ...
    <div class="pet_content pet_content_list">
      <div class="pet_zlnr">
        <div class="pet_zlnr_user">
            <div class="pet_zlnr_user_l"><img src="/Admin/img/qq1.png" alt=""></div>

...
<div class="pet_content_main">
    ...
    <div>
        <p><span><a href="/index.php/Admin/Index/index" ><<返回</a><span>大赛通告</p>
...
<script>
    $(function(){
        // 加载资讯消息
        var Path = "/index.php/Admin/Notice/getAll";
        $.ajax({
            url:Path,
            type:'POST', //GET
            ...
            success:function(data,textStatus,jqXHR){
                ...
                for (var i = 0; i < rows.length; i++) {
                    html+= "<li class='am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block'>"
                        ...
                        +"<h3 class='am-list-item-hd pet_list_one_bt'><a href='/index.php/Admin/Notice/noticeDetailPage?id="+rows[i].id+"' class=''>"+rows[i].title+"["+rows[i].createtime+"]</a></h3>"
